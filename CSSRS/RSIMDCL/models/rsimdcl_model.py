...
class RSIMDCLModel(BaseModel):
    """
    This class implements the restricted SimDCL.
    """
    ...
    def calculate_Sim_loss_all(self, src1, tgt1, src2, tgt2):
        ...
        sim_loss = self.criterionSim(feature_realA_out, feature_fakeA_out) + \
                   ...
                   self.criterionSim(feature_realA_out, feature_fakeB_out) + \
                   self.criterionSim(feature_fakeA_out, feature_realB_out)
